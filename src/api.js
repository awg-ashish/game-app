...
export const searchGames_url = (game_name, page_no = 1) => {
    console.log(`${base_url}/games?search=${game_name}&page_size=9`);
    return `${base_url}/games?search=${game_name}&page=${page_no}&page_size=9`;
};
